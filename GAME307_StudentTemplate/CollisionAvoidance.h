...
public:
    ...
    void HandlePlayerNPCollision_(PlayerBody* player, Character* npc, SDL_Renderer* renderer);
    ...
    void HandleNPCWallCollision_(Character* npc, const std::vector<Wall*>& walls);
